<template>
    <div class="w-full py-5 fixed top-0 left-0 right-0 z-50"
    ...
    <div v-if="isBurger"
        class="select-none w-full py-5 pb-8 fixed left-0 right-0 z-50 overflow-hidden duration-200 sm:mt-[76px] mt-[71.5px]"
        :class="[getMode ? 'bg-black' : 'bg-white']">
