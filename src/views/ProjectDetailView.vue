        ...
        <div class="container py-40 relative z-20">
            <div class="flex lg:flex-row flex-col items-center">
                <div class="flex-1 flex flex-col space-y-6">
                    <img class="w-full lg:h-[450px] object-cover" src="/imgs/project-6.webp">
                ...
                <div class="lg:flex-1 w-full flex phone:flex-row flex-col lg:ml-10 lg:mt-0 mt-10 phone:space-x-10">
                    <div class="phone:w-3/4 w-full flex flex-col space-y-20">
                        <div class="flex flex-col">
                            <p class="font-rajdhani font-medium xl:text-xl lg:text-lg text-base text-m_orange-100 mb-4">Logo Design</p>
                            <h2 class="font-rajdhani font-medium xl:text-6xl lg:text-5xl md:text-4xl text-3xl" :class="[getMode ? 'text-white' : 'text-black']">Freyja project</h2>
                        </div>
                        <div class="flex flex-col space-y-2">
                            <h4 class="font-inter font-normal lg:text-base md:text-sm text-xs text-m_gray-800">Fonts</h4>
                            <h2 class="font-bodoni font-normal text-3xl"
                                :class="[getMode ? 'text-white' : 'text-black']">Bodoni</h2>
                            <p class="font-bodoni font-normal lg:text-base md:text-sm text-xs text-m_gray-900">ABCDEFGHIJKLMNOPQRSTUVWXYZ</p>
                            <p class="font-bodoni font-normal lg:text-base md:text-sm text-xs text-m_gray-900">0123456789</p>
                        </div>
                        <div class="flex flex-col space-y-2">
                            ...
                            <div class="flex items-center space-x-4">
                                <div class="flex flex-col space-y-2" v-for="item in colors" :key="item">
                                    <div :style="{ backgroundColor: `#${item}` }" class="md:w-16 md:h-16 w-10 h-10 rounded-full"></div>
                    ...
                    <div class="phone:w-1/2 w-full flex flex-col justify-end phone:space-y-40 phone:mt-0 mt-20 space-y-10">
                        ...
                        <div class="flex flex-col space-y-8">
                            ...
                            <div class="w-fit">
                                <router-link to="/contact"
                                    class="px-8 py-3 bg-m_orange-100 rounded-full text-white font-medium text-nowrap font-rajdhani lg:text-lg sm:text-base text-sm hover:opacity-80 duration-500">Go to website</router-link>
                            </div>
                        </div>
                    </div>
                </div>
